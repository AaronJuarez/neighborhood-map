...
(function () {
	...
	app.ViewModel = function() {
		...
		this.infoWindowName = ko.observable('');
		this.infoWindowDescription = ko.observable('');

		this.setActivePlace = function(place) {
			self.activePlace(place);
		};

		this.setInfoWindowName = function(place) {
			self.infoWindowName(place);
		};

		this.setInfoWindowDescription = function(place) {
			self.infoWindowDescription(place);
		};
		...
		this.deleteInfo = function() {
			self.activePlace('');
			app.AppView.flickrData('');
			app.AppView.wikipediaData('');
		};
